...
- Image generation uses `client.models.generate_content` with `gemini-3.1-flash-image` and IMAGE response modality.
- TTS uses the documented Interactions API for `gemini-3.1-flash-tts-preview` and returns PCM wrapped as WAV.
